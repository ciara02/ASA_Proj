<svg style="width: 1.4rem" version="1.1" viewBox="0 0 36 36" preserveAspectRatio="xMidYMid meet"
    ...
    <path d="M29,16h2V6.68A1.66,1.66,0,0,0,29.35,5H27.08V7H29Z" class="clr-i-outline clr-i-outline-path-3"></path>
    <path
    ...
    <rect x="0" y="0" fill-opacity="0"></rect>
</svg>
