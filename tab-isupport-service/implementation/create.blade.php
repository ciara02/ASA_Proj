...
@section('content')
    ...
    <div class="container">
        ...
        <form id="projectCreate" method="POST" action="{{ route('tab-isupport-service.implementation.store') }}" 
            enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-header" style="background-color: #0056b3; color:white">
                   <b> Add Project/Opportunity </b>
                </div>
                ...
                <div class="card-body">
                     ...
                     <div class="row mb-4 pb-4 border-bottom">
                        ...
                        <div class="col-md-4 d-flex flex-column gap-2 mb-2">
                            ...
                            <div class="d-flex align-items-center gap-2 mb-3">
                                <label for="projectPeriodFrom" class="form-label me-1">From:</label>
                                <input type="date" name="projectPeriodFrom" id="projectPeriodFrom" class="form-control projectPeriodFrom" min="2023-01-01" placeholder="mm/dd/yyyy">
                            </div>
                            <div class="d-flex align-items-center gap-4">
                                <label for="projectPeriodTo" class="form-label me-2">To:</label>
                                <input type="date" name="projectPeriodTo" id="projectPeriodTo" class="form-control projectPeriodTo" min="2023-01-01" placeholder="mm/dd/yyyy">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 d-flex flex-column gap-2 mb-2">
                            <label for="addMember" class="form-label ">Team Member/s: <small style="color:rgb(142, 142, 142);"></small></label>
                    ...
                    <div class="row mb-4 pb-4 border-bottom">
                        ...
                        <div class="col-md-4  align-items-center gap-2">
                            ...
                            <span id="productLineError" class="text-danger"></span>
                        </div>
                        ...
                        <div class="col-md-4  align-items-center gap-2">
                            ...
                            <span id="mbsError" class="text-danger"></span>
                        </div>
                    </div>
                    ...
                    {{-- <div class="row" style="margin-bottom: 1rem; padding-bottom: 1rem; border-bottom: 1px solid #ccc">
                        <div class="col-md-4 d-flex align-items-center gap-2">
                            ...
                            <input type="number" name="projectMandays" id="projectMandays" class="form-control"
                                placeholder="How many manday/s?" required>
                            <span id="projectMandaysError" class="text-danger"></span>
                        </div>
                        <div class="col-md-4 d-flex align-items-center gap-2">
                            <label for="projectAmountGross" class="form-label">Project Amount (Gross):</label>
                            <input type="number" name="projectAmountGross" id="projectAmountGross" class="form-control"
                                placeholder="iSupport Revenue only." value="" required>
                            <span id="projectAmountGrossError" class="text-danger"></span>
                        </div>
                        <div class="col-md-4 d-flex align-items-center gap-2">
                            <label for="poNumber" class="form-label">PO #:</label>
                            <input type="text" name="poNumber" id="poNumber" class="form-control" value=""
                        ...
                        <div class="col-md-4 d-flex align-items-center gap-2">
                            ...
                            <input type="number" name="perMondayCost" id="perMondayCost" class="form-control" disabled>
                            <span id="perMondayCostError" class="text-danger"></span>
                        </div>
                        <div class="col-md-4 d-flex align-items-center gap-2">
                            <label for="projectAmountNet" class="form-label">Project Amount (Net):</label>
                            <input type="number" name="projectAmountNet" id="projectAmountNet" class="form-control"
                                disabled>
                            <span id="projectAmountNetError" class="text-danger"></span>
                        </div>
                        <div class="col-md-4 d-flex align-items-center gap-2">
                            <label for="soNumber" class="form-label">SO #:</label>
                            <input type="text" name="soNumber" id="soNumber" class="form-control" value=""
                                placeholder="Input SO number" required>
                            <span id="soNumberError" class="text-danger"></span>
                        </div>

                        <div class="col-md-4 d-flex align-items-center gap-2">
                            <label for="mondayUsed" class="form-label">Manday/s Used:</label>
                            <input type="text" name="mondayUsed" id="mondayUsed" class="form-control" disabled
                                placeholder="Total manday used">
                            <span id="mondayUsedError" class="text-danger"></span>
                        </div>
                        <div class="col-md-4 d-flex align-items-center gap-2">
                    ...
                    <div class="row mb-4 pb-4 border-bottom">
                        <div class="col-md-4 d-flex flex-column gap-2 mb-2">
                            ...
                            <div>
                                ...
                                <div id="projectMandaysError" class="text-danger"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 d-flex flex-column gap-2 mb-2">
                            ...
                            <div>
                                ...
                                <div id="projectAmountGrossError" class="text-danger"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 d-flex flex-column gap-2 mb-2">
                            ...
                            <div>
                                ...
                                <div id="poNumberError" class="text-danger"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 d-flex flex-column gap-2 mb-2">
                            ...
                            <div>
                                ...
                                <div id="perMondayCostError" class="text-danger"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 d-flex flex-column gap-2 mb-2">
                            ...
                            <div>
                                ...
                                <div id="projectAmountNetError" class="text-danger"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 d-flex flex-column gap-2 mb-2">
                            ...
                            <div>
                                ...
                                <div id="soNumberError" class="text-danger"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 d-flex flex-column gap-2 mb-2">
                            ...
                            <div>
                                ...
                                <div id="mondayUsedError" class="text-danger"></div>
                            </div>
                        </div>
            ...
            <div class="row mt-3">
                <div class="col-md-4">
                    <label for="implementationSupportingDocument" class="form-label">Attach Supporting Documents
                        Here:</label>
                    <input class="form-control" type="file" name="implementationSupportingDocument[]"
                        id="implementationSupportingDocument" multiple>
                </div>
            </div>

            <div class="row mt-3 cancel justify-content-center d-flex gap-2">
                <a class="btn btn-danger" style="width: fit-content" type="button"
                    href="{{ route('tab-isupport-service.implementation.index') }}">Cancel</a>
                <button class="btn btn-primary" style="width: fit-content" id="save" type="submit">Submit
                    form</button>
            </div>
        </form>
    </div>
