...
<body>
    <div class="container">
        <div class="header">
            <h1>Merit and Demerit Request Created For Approval</h1>
        </div>
        <div class="content">
            <p>Good Day,</p>
            <p>This is to inform you that a new merit and demerit request (ID: <b>{{ $record->id }}</b>) has been created by <b>{{ Auth::user()->name }}</b>.</p>
