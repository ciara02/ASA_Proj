...
<body>
    <div class="container">
        <div class="header">
            <h1>Merit and Demerit Request Updated For Approval</h1>
        </div>
        <div class="content">
            <p>Good Day,</p> 
            <p>This is to inform you that a merit and demerit request (ID: <b>{{ $record->id }}</b>) has been updated by <b>{{ Auth::user()->name }}</b>.</p>
