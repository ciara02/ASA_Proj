    ...
    <div class="row">
        <center>
            ...
            <table style="width: 90%; max-width: 90%;" cellpadding="0" cellspacing="0" id="">
                <thead cellpadding="0" cellspacing="0" border="0">
                    <tr style="padding: 8px; border: 1px solid #010058;">
                        <th style="color: yellow; padding: 8px; border: 2px solid #010058; text-align: center; background-color: #0400ff;">
                        ...
                        <td style="padding: 8px; border: 1px solid #010058; text-align: center;">
                            @if (isset($data['formData']) && is_array($data['formData']))
                                ...
                                @foreach ($sortedData as $participantData)
                                    <span> {{ $counter++ }}. {{ $participantData['participant'] }} - {{ $participantData['position'] }} </span><br>
                                @endforeach
                            @else
                                No data available.
                            @endif
            ...
            <br>
            <table style="width: 90%; max-width: 90%; table-layout: fixed;" cellpadding="0" cellspacing="0" id="">
                <thead cellpadding="0" cellspacing="0" border="0">
                    <tr style="padding: 8px; border: 1px solid #010058;">
                        <th
