...
<body>
    <div class="container">
        <div class="header">
            <h1>Merit and Demerit Request Severity Level Update</h1>
        </div>
        <div class="content">
            <p>Good Day,</p> 
            <p>This email is intended to inform you that the severity level for (ID: <b>{{ $record->id }}</b>) merit/demerit request below has been updated to {{ $record->points }} point/s by <b>{{ Auth::user()->name }}</b>.</p>
