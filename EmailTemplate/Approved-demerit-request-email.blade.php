...
<body>
    <div class="container">
        <div class="header">
            <h1>Merit and Demerit Request Approved</h1>
        </div>
        <div class="content">
            <p>Good Day,</p> 
            <p>This is to inform you that a merit and demerit request (ID: <b>{{ $record->id }}</b>) has been approved by <b>{{ Auth::user()->name }}</b>.</p>
